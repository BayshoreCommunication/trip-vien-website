        ...
        {team.map((member, index) => {
          ...
          return (
            ...
            >
              ...
              >
                {/* IMAGE */}
                <div className="col-span-1 relative rounded-2xl overflow-hidden w-full max-w-md mx-auto">
                  <Image
                    src={member.image}
                    alt={member.name}
                    width={500}
                ...
                <div className=" col-span-2">
                  <div className=" border-b-1 border-[#E7B540] pb-1 mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                      {member.education && (
                        <div>
                          ...
                          <ul className="text-base space-y-1 opacity-80">
