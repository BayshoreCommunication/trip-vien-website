...
export const PRACTICE_DATA: Record<string, PracticeArea> = {
 ...
 "immigration": {
  ...
  services: [
    {
      ...
      description: "Legal guidance through the U.S. citizenship and naturalization process.",
      image: "/images/services/img1.png",
      details_img: "/images/services/car-accident.png",
      content:
    ...
    },
    {
      ...
      description: "Marriage-based green card representation for spouses of U.S. citizens and residents.",
      image: "/images/services/img2.png",
      details_img: "/images/services/car-accident.png",
      content:
    ...
    },
    {
      ...
      description: "Family-sponsored green card petitions under preference categories.",
      image: "/images/services/img3.png",
      details_img: "/images/services/car-accident.png",
      content:
    ...
    },
    {
      ...
      description: "Green card services for immediate relatives of U.S. citizens.",
      image: "/images/services/img4.png",
      details_img: "/images/services/car-accident.png",
      content:
    ...
    },
    {
      ...
      description: "Intra-company transfer visas for executives and managers.",
    ...
    },
    {
      title: "Asylum",
      slug: "asylum",
      description: "Protection-based relief for individuals fearing persecution.",
    ...
    },
    {
      ...
      description: "Non-immigrant visa services for work, travel, and religious purposes.",
    ...
    },
    {
      ...
      description: "Case preparation and document submission through the NVC.",
    ...
    },
    {
      ...
      description: "Preparation and representation for U.S. consular interviews.",
  ...
  "criminal-defense": {
    title: "DUI & Criminal Defense Services",
    services: [
      {
      ...
      },
      {
        ...
        description: "Strategic motion filing in immigration and criminal cases.",
        image: "/images/services/img17.png",
      ...
      },
      {
        title: "Crimmigration",
        slug: "crimmigration",
        description: "Defense where criminal law and immigration law intersect.",
        image: "/images/services/img19.png",
        details_img: "/images/services/legal-documents.png",
        content:
