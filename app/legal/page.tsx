...
export const metadata: Metadata = {
  title: "Legal Information | TripVien Law",
  description: "Review general legal information and policies for the TripVien Law website.",
  alternates: {
    canonical: "https://www.tripvienlaw.com/legal",
  },
};
